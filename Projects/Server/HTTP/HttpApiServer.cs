...
public static class HttpApiServer
{
    ...
    public static int Port { get; private set; } = 8081;
    ...
    public static void Configure()
    {
        ...
        Port = ServerConfiguration.GetSetting("httpApi.port", 8081);
...
internal static class HttpApiModuleInitializer
{
    [ModuleInitializer]
    public static void Initialize()
    {
        // Configure and start HTTP API server when Server assembly loads
